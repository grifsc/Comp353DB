...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO kqc353_4.FamilyMember (
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                if (strpos($stmt->error, 'SIN') !== false) {
                    ...
                    $errors['database'] = "Error creating family member: " . $stmt->error;
                }
            }
...
<main>
    ...
    <form method="post" action="create.php">
        ...
        <div class="form-actions">
            <button type="submit" class="submit-button">Create Family Member</button>
